...
# @login_required
@csrf_exempt
def manage_system_assessment_result_api(request, system_id, sar_id=None):
    """Form to create or edit system assessment result"""

    print("INSIDE views_api.manage_system_assessment_result_api")
    ...
    # Test reading sent data and responding

    for key, v in list(request.POST.lists()) + list(request.FILES.items()):
        print(key, v)

    # TEMP SEND SIMPLE RESPONSE
    ...
    # REFACTOR BELOW FOR API SUBMISSION
