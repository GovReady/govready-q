# Generated by Django 3.2.16 on 2022-10-31 18:31
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('controls', '0086_element_locations'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('links', models.ManyToManyField(blank=True, related_name='revision', to='controls.Link')),
                ('props', models.ManyToManyField(blank=True, related_name='revision', to='controls.Prop')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='element',
            name='documents',
            field=models.ManyToManyField(blank=True, help_text='A location, with associated metadata that can be referenced.', related_name='documents', to='controls.DocumentId'),
        ),
        migrations.AddField(
            model_name='element',
            name='remarks',
        ...
        migrations.AddField(
            model_name='element',
            name='revisions',
            field=models.ManyToManyField(blank=True, help_text='A location, with associated metadata that can be referenced.', related_name='revisions', to='controls.Revision'),
        ),
    ]
