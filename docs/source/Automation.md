...
* Datagrid fields: Encoded as a JSON array of strings, where each string is a programmatic identifier for a selected choice.
...
Datagrid fields appear as _____to be completed________.
