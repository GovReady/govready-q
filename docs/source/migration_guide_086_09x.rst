...
Major Changes between v0.8.6 and v0.9.x
---------------------------------------

Changes GovReady-Q users will encounter in v0.9.x:
...
.. list-table::
   ...
   * - User "is staff" and "is super user" set in Django Admin.
     - User "is staff" and "is super user" set in Django Admin.
     - Roles preserved, see Roles and Permissions in v0.9.x section.
...
* Perform the upgrade to v0.9.x.release.
...
* Mark all old Notifications ``emailed`` as True. (v0.9.x notification checks emailed status of notifications and sets emailed to True after email is sent.)
...
Roles and Permissions in v0.9.x
-------------------------------
