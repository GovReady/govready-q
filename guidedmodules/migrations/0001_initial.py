# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2016-05-04 16:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('for_answer', models.ForeignKey(help_text='The Answer that this discussion thread is for.', on_delete=django.db.models.deletion.CASCADE, to='guidedmodules.Answer')),
            ],
        ),
        migrations.CreateModel(
            name='Invitation',
        ...
        migrations.AddField(
            model_name='comment',
            name='discussion',
            field=models.ForeignKey(help_text='The Discussion that this comment is attached to.', on_delete=django.db.models.deletion.CASCADE, to='guidedmodules.Discussion'),
        ),
        migrations.AddField(
            model_name='comment',
            name='replies_to',
            field=models.ForeignKey(help_text='If this is a reply to a Comment, the Comment that this is in reply to.', on_delete=django.db.models.deletion.CASCADE, related_name='replies', to='guidedmodules.Comment'),
        ),
        migrations.AddField(
            model_name='comment',
            name='user',
