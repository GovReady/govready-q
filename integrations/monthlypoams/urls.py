...
urlpatterns = [
    ...
    url(r"^admin$", views.monthly_poams_admin, name=f'{INTEGRATION_NAME}_monthly_poams_admin'),

    url(r'^export_csam_poams_xlsx$', views.export_csam_poams_xlsx, name="export_csam_poams_xlsx"),
    ...
    # url(r"^local/system/(?P<system_id>.*)$", views.get_paired_remote_system_info_using_local_system_id, name=f'{INTEGRATION_NAME}_system_info'),
