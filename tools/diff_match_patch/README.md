# README - diff-match-patch

## About

This tool is the Python3 version of [Google's diff-match-patch library](https://github.com/google/diff-match-patch).

diff-match-patch is published under Apache 2.0 License: [https://github.com/google/diff-match-patch/blob/master/LICENSE[(https://github.com/google/diff-match-patch/blob/master/LICENSE)]

## From diff-match-patch README
