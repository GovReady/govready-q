                            ...
                            <SidebarHeader class="sidebardarkheader">
                                <Grid container >
                                    <Grid item xs={12}>
                                        ...
                                        <span class="sidebardark-project-details" title="{{data.project.version_comment}}">  Project ID: {data.project.id}&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;System ID: {data.project.system.id}&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;Version: {data.project.version}</span>
                                        <br/>
